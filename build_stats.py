...
def rpc_batch(calls, rpc_url, tries=3):
    ...
    for attempt in range(tries):
        ...
        try:
            ...
            if attempt == tries - 1:
                print(f"warn: rpc batch failed: {e}", file=sys.stderr)
                return []
...
def fetch_owners():
    ...
    batch    = int(os.environ.get("RPC_BATCH", "150"))
    workers  = int(os.environ.get("RPC_WORKERS", "6"))
